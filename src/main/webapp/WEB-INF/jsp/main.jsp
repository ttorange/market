        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">Welcome To ISHOU MARKET Manager System！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="/static/img/aaa.jpg" alt="company1">
                                <div class="carousel-caption">
                                    <h3>TT和NN开发的台管理系统</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/p1%20(2).jpg" alt="company2">
                                <div class="carousel-caption">
                                    <h3>可以管理供应商</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="/static/img/p1%20(3).jpg" alt="company3">
                                <div class="carousel-caption">
                                    <h3>也可以管理账单</h3>
                                </div>
                            </div>
