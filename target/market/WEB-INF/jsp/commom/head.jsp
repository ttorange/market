    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" id="company_logo" href="#">ISHOU · MARKET</a>
            </div>

            <div class="collapse navbar-collapse" id="hrms-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="#">商城介绍 <span class="sr-only">(current)</span>  </a>
                    </li>
                    <li><a href="static/html/newslist">商城日报</a></li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            ...
                            <li><a href="#" class="hrms_logout"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> 退出账号</a></li>
                        </ul>
                    </li>
...
<script type="text/javascript">
    ...
    $("#company_logo").click(function () {
        $(this).attr("href", "/market/main");
    });
    //账号退出
    $(".hrms_logout").click(function () {
        window.location.href = "/market/logout";
    });
</script>
</body>
</html>
